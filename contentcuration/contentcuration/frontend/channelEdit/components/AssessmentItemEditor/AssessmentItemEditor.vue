  ...
  <Uploader ref="uploader" :presetID="imagePreset">
    <template #default="{ handleFiles }">
      ...
      <VLayout v-if="windowsNativeQuestion">
        ...
        />
        <p v-if="applicationSelected.length" id="application_type_dropdown" hidden="true">
          {{ applicationSelected }} are selected in Action Type
        </p><p v-else hidden="true">
          No Value Selected
        </p>
      </VLayout>
      <VLayout v-if="applicationType">
        ...
        />
        <p v-if="actionSelected.length" id="action_type_dropdown" hidden="true">
          {{ actionSelected }} are selected in Action Type
        </p><p v-else hidden="true">
          No Value Selected
        </p>
      </VLayout>
