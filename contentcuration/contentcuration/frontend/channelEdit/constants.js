...
export const RouteNames = {
  ...
  BLIMEY_EXERCISE:'BLIMEY_EXERCISE',
  UPLOAD_FILES: 'UPLOAD_FILES',
  UPLOAD_TXT_FILES : 'UPLOAD_TXT_FILES',
  TRASH: 'TRASH',
...
export const AssessmentItemTypeLabels = {
  ...
  [AssessmentItemTypes.WINDOW_NATIVE_QUESTION]: 'questionTypeWindowNative',
};
...
export const modes = {
  ...
  UPLOAD: 'UPLOAD',
  VIEW_ONLY: 'VIEW_ONLY',
  NEW_UPLOAD_URL : 'NEW_UPLOAD_URL',
  NEW_BLIMEY_EXERCISE : 'NEW_BLIMEY_EXERCISE'
};
