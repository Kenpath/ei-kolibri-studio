...
const FormatPresetsMap = new Map([
  ...
  [
    'txt',
    {
      ...
      kind: 'document',
      allowed_formats: ['txt'],
      associated_mimetypes: ['text/plain'],
    },
  ],
  [
    'txt_thumbnail',
  ...
  [
    'xls',
    {
      ...
      kind: 'document',
      allowed_formats: ['xls'],
      associated_mimetypes: ['application/vnd.ms-excel'],
    },
  ],
  [
    'xls_thumbnail',
...
export const FormatPresetsNames = {
  ...
  DOCUMENT: 'document',
  TXT: 'txt',
  TXT_THUMBNAI: 'txt_thumbnail',
  DOCX: 'docx',
  DOCX_TUMBNAIL: 'docx_thumbnail',
  PPTX: 'pptx',
  PPTX_THUMBNAIL: 'pptx_thumbnail',
  XLS: 'xls',
  XLS_THUMBNAIL: 'xls_thumbnail',
